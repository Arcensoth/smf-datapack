...
execute if score $rand temp matches 3 run tellraw @s [{"text": "[SMF]", "color": "aqua"}, {"text": " Smell my feet!", "color": "yellow"}]
...
execute if score $rand temp matches 8 run tellraw @s [{"text": "[SMF]", "color": "aqua"}, {"text": " DESTROY ALL VILLAGERS", "color": "yellow"}]
execute if score $rand temp matches 9 run tellraw @s [{"text": "[SMF]", "color": "aqua"}, {"text": " Modules! Modules everywhere!", "color": "yellow"}]
