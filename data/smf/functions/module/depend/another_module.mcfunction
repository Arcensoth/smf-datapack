...
execute unless entity @e[tag=smf.temp.depend.another_module] run tellraw @s [{"text":"[SMF]", "color": "aqua"}, {"text": " Uh oh! Missing dependency ", "color": "red"}, {"text": "another_module", "color": "dark_red"}, {"text": " or the wrong version is installed.", "color": "red"}]
