...
tellraw @s [{"text":"[Standard Module Format]", "color": "aqua"}, {"text": " Module version ", "color": "white"}, {"text": "", "color": "yellow", "extra": [{"score": {"name": "$vmajor", "objective": "smf_module"}}, {"text": "."}, {"score": {"name": "$vminor", "objective": "smf_module"}}, {"text": "."}, {"score": {"name": "$vpatch", "objective": "smf_module"}}]}, {"text": " installed!", "color": "white"}]
